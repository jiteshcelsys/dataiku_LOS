            ...
            <Box sx={{ display: "flex", alignItems: "center" }}>
              <Box sx={{ position: "relative" }}>
                <Avatar
                  ...
                  sx={{ width: 40, height: 40, bgcolor: "#fce1e9" }}
                >
                  AU
                </Avatar>
                <Box
          ...
          <Box sx={{ flexGrow: 1, p: 4, bgcolor: "white" }}>
            ...
            <Box>
              ...
              >
                <CardContent sx={{ p: 0 }}>
                  {/* Filters */}
                  <Box sx={{ p: 2, borderBottom: "1px solid #dee1e6", display: "flex", gap: 2, alignItems: "center" }}>
                    <TextField
                  ...
                  <TableContainer>
                    <Table>
                      <TableHead sx={{ bgcolor: "grey.100" }}>
                        <TableRow>
                          <TableCell sx={{   fontWeight: 500, color: "#565d6d", fontSize: 14 }}>
                            ID
                          </TableCell>
                          <TableCell sx={{   fontWeight: 500, color: "#565d6d", fontSize: 14 }}>
                            Type
                          ...
                          <TableCell sx={{   fontWeight: 500, color: "#565d6d", fontSize: 14 }} align="right">
                            Actions
                          </TableCell>
                        </TableRow>
                      </TableHead>
                      <TableBody>
                        {alertsData.map((alert, index) => (
                          <TableRow key={index}>
                            <TableCell sx={{   fontWeight: 500, color: "#171a1f", fontSize: 14 }}>
                              {alert.id}
                            </TableCell>
                            <TableCell>
                              <Chip
                            ...
                            <TableCell sx={{   fontWeight: 400, color: "#171a1f", fontSize: 14 }}>
                              {alert.source}
                            </TableCell>
                            <TableCell>
                              <Chip
