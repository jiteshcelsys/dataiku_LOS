import {
  ...
  export const TalentflowApplicantSubsection = (): JSX.Element => {
    const navigationItems = [
      ...
      { icon: SquareGanttChart, label: "Tasks", active: false },
    ...
    return (
      <Box sx={{ width: "100%", height: "100%", bgcolor: "white", overflow: "hidden", boxShadow: "0px 3px 6px rgba(18, 15, 40, 0.12)", display: "flex" }}>
        {/* Left Sidebar */}
        <Drawer
          variant="permanent"
          sx={{
        ...
        >
          {/* Logo */}
          <Box sx={{ p: 1.5 }}>
            <img style={{ width: 198, height: 52 }} alt="Logo" src="/image-1.png" />
          </Box>
          ...
          <Box sx={{ flexGrow: 1, px: 0.5, py: 2 }}>
            ...
            <Box sx={{ mb: 2 }}>
              ...
              <List sx={{ py: 0 }}>
                {navigationItems.slice(1, 3).map((item, index) => {
        ...
        <Box sx={{ flexGrow: 1, display: "flex", flexDirection: "column" }}>
          ...
          <Box sx={{ flexGrow: 1, p: 3, display: "flex", gap: 3 }}>
            ...
            <Box sx={{ flexGrow: 1, display: "flex", flexDirection: "column", gap: 3 }}>
              ...
              <Card sx={{ border: "1px solid #dee1e6", boxShadow: "0px 0px 1px rgba(23, 26, 31, 0.05), 0px 0px 2px rgba(23, 26, 31, 0.08)" }}>
              ...
              <Card sx={{ border: "1px solid white", boxShadow: "0px 0px 1px rgba(23, 26, 31, 0.05), 0px 0px 2px rgba(23, 26, 31, 0.08)" }}>
                <CardContent sx={{ p: 3 }}>
                  ...
                  <Box sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
                    {comments.map((comment, index) => (
                      <Box
                        ...
                        sx={{
                          pb: 2,
                          borderBottom: index < comments.length - 1 ? "1px solid #e5e7eb" : "none",
                        }}
                      >
