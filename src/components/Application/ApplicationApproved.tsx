  ...
  return (
    <Container maxWidth="md" sx={{ py: 4 }}>
      <Paper elevation={2} sx={{ p: 4, textAlign: 'center' }}>
        ...
        <Typography variant="h4" gutterBottom sx={{ fontWeight: 600, color: '#4caf50' }}>
        ...
        {currentOffer && (
          <Box sx={{ my: 4 }}>
              ...
              <Grid item xs={6}>
                <Card>
                  <CardContent>
                    ...
                    <Typography variant="h6" sx={{ fontWeight: 600 }}>
                      {currentOffer.termMonths} Months
                    </Typography>
                  </CardContent>
                </Card>
              </Grid>
            ...
            <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
              Your personalized loan offer document is ready for download. Please review all terms and conditions carefully before proceeding.
            </Typography>
            ...
            <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
              To finalize your loan, please provide your e-signature below. This acts as your legal agreement to the terms.
            </Typography>
