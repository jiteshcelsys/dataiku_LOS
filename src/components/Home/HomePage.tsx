          ...
          <Grid container spacing={4} alignItems="center">
            <Grid item xs={12} md={6}>
              ...
              <Typography variant="h6" sx={{ mb: 4, opacity: 0.9 }}>
                Apply for personal loans, auto loans, mortgages, and more with
                competitive rates and fast approval times. Join thousands of
                satisfied customers.
              </Typography>
        ...
        <Container maxWidth="md">
          <Box sx={{ textAlign: "center" }}>
            ...
            <Typography variant="h6" color="text.secondary" sx={{ mb: 4 }}>
              Join thousands of customers who trust us with their financial
              needs
            </Typography>
            <Button
              variant="contained"
